...
When it's running as a load test on flood.io, upload the the CSV alongside your script.
...
[TestData]: /docs/1.0/api/TestData#testdata
[TestDataFactory]: /docs/1.0/api/TestData#testdatafactory
[TestDataSource]: /docs/1.0/api/TestData#testdatasource

---

You're almost done! In the next section we'll talk about some useful tips for scripting in Element.
